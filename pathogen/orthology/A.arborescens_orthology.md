...
```bash
  ...
  cd $ProjDir
  IsolateAbrv=Aalt_ssp_arb_675_970013_970016
...
```bash
  Taxon_code=Aa_1
  Fasta_file=gene_pred/augustus/A.alternata_ssp._arborescens/675/675_augustus_preds.aa
  Id_field=1
...
```bash
  Taxon_code=Aa_2
  Fasta_file=gene_pred/augustus/A.alternata_ssp._arborescens/97.0013/97.0013_augustus_preds.aa
  Id_field=1
  orthomclAdjustFasta $Taxon_code $Fasta_file $Id_field
  mv "$Taxon_code".fasta $WorkDir/formatted/"$Taxon_code".fasta
```
...
```bash
  Taxon_code=Aa_3
  Fasta_file=gene_pred/augustus/A.alternata_ssp._arborescens/97.0016/97.0016_augustus_preds.aa
  Id_field=1
  orthomclAdjustFasta $Taxon_code $Fasta_file $Id_field
  mv "$Taxon_code".fasta $WorkDir/formatted/"$Taxon_code".fasta
```
