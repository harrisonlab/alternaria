...
for ReadsBam in $(ls analysis/genome_alignment/bowtie/*/*/vs_650/650_contigs_unmasked.fa_aligned_sorted.bam | grep -w -e '1166' -e '648' -e '650' -e '97.0016'); do
...
```bash
 ...
 BlastHits=$(ls analysis/blast_homology/*/650/*_CDC_genes.fa_homologs.gff)
