...
for line in phibase_lines:
    ...
    # print ";".join([split_line[0], split_line[1]])

#-----------------------------------------------------
# Load Toxin Gene hits into a blast hits dictionary
#-----------------------------------------------------

toxin_dict = defaultdict(list)
for line in toxin_lines:
    line = line.rstrip()
    split_line = line.split()
    toxin_dict[split_line[0]].append(split_line[1])
...
"TF",
'PHIbase homolog', 'Alternaria toxin homolog'
...
for gene_id in gene_id_list:
    ...
    if phi_dict[gene_id]:
        phi_col = ";".join(phi_dict[gene_id])
    else:
        phi_col = ""
    useful_columns.append(phi_col)

    if toxin_dict[gene_id]:
        toxin_col = ";".join(toxin_dict[gene_id])
    else:
        toxin_col = ""
    useful_columns.append(toxin_col)
